    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap">
            <div class="card-title">
                <h1 class="card-label">البيانات الخاصة باضافة مستخدم جديد</h1>
            </div>
        ...
        <div class="accordion accordion-solid accordion-toggle-plus" id="accordionExample3">
            <form class="needs-validation " name="form" action="{{route('admin.users.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="card">
            ...
            <!--begin: Datatable-->
                       <div class="modal-body">
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <input type="text" name="pin" class="form-control @error('pin') is-invalid @enderror" id="pin" value="{{old('pin')}}"
                                   aria-describedby="emailHelp" placeholder="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                           ...
                           <div class="col-lg-6 col-sm-12">
                               ...
                               <input type="text" name="balance" class="form-control  @error('balance') is-invalid @enderror"  id="balance" value="{{old('balance')}}"
                                      aria-describedby="emailHelp" placeholder="">
                ...
                <div id="collapseTwo3" class="collapse" data-parent="#accordionExample3">
                    <div class="card-body">
                        ...
                        <div class="modal-body">
                            <div class="form-group row">
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <input type="text" name="line1" class="form-control @error('line1') is-invalid @enderror" id="line1" value="{{old('line1')}}"
                                           aria-describedby="emailHelp" placeholder="">
                                    <div class="invalid-feedback">
                                      (Line 1)  العنوان
                                    </div>
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    ...
                                    <input type="text" name="line2" class="form-control" id="line2" value="{{old('line2')}}"
                                           aria-describedby="emailHelp" placeholder="">
                                    <div class="invalid-feedback">
                                        (Line 2)  العنوان
                        ...
                        <div class="col-lg-6 col-sm-12">
                            ...
                            <select class="form-control  selectpicker country_id @error('country_id') is-invalid @enderror" data-live-search="true" name="country_id"  data-container=".accordion">
                                <option value="">اختر</option>
                            ...
                            <select class="form-control select_2 city_id @error('city_id') is-invalid @enderror" data-live-search="true" name="city_id" data-container=".accordion">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6 col-sm-12">
                                        ...
                                        <input type="text" name="post_code" class="form-control @error('post_code') is-invalid @enderror" id="post_code" value="{{old('post_code')}}"
                                               aria-describedby="emailHelp" placeholder="">
                ...
                <div id="collapseThree3" class="collapse" data-parent="#accordionExample3">
                    <div class="card-body">
                        ...
                        <div class="w-50 text-center">
                            ...
                            <img src="{{asset('assets/images/user_logo.jfif')}}" style="width: 100px"
                                 class="img-thumbnail img-preview"  id="imagePreview" alt="">

                        </div>

                    </div>
                    <div class="form-group row image_id_row" style="display: none;">
                        <div class="col-lg-6 col-sm-12">
                        ...
                        <div class="w-50 text-center">
                            ...
                            <img src="{{asset('assets/images/ID_Logo.jpg')}}" style="width: 100px"
                            ...
                            <div class="form-group row record" style="display: none;">
                                ...
                                <div class="w-50 text-center">
                                    ...
                                    <img src="{{asset('assets/images/commercial_record_image.jpg')}}" style="width: 100px"
