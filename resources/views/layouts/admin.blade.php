...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="{{route('admin.index')}}">
        ...
        <img alt="Logo" src="{{url('assets/images/settings/'.$setting->website_logo)}}" style="width: 100%;"/>
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{route('admin.index')}}"
                   class="brand-logo">
                                    <img alt="Logo" src="{{url('assets/images/settings/'.$setting->website_logo)}}" style="width: 90%; height: 50%"/>
                                ...
                                <form>
                                    ...
                                    <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                                        ...
                                        <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#topbar_objection_notifications">اعتراضات</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#topbar_report_notifications">تبليغات</a>
                                            </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active show p-8" id="topbar_orders_notifications" role="tabpanel">
...
{{--                                            @endif--}}
                                        ...
                                        <div class="tab-pane" id="topbar_objection_notifications" role="tabpanel">
                                            <!--begin::Nav-->
                                            <div class="navi navi-hover scroll my-4" data-scroll="true"
                                                 data-height="300" data-mobile-height="200">
...
{{--                     style="background-image:url('{{auth('admin')->user()->getAdminAvatar()}}')"--}}
                >
...
// <script>
    ...
    $("textarea.description_editor").each(function(){
